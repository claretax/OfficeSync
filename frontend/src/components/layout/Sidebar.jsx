...
function Sidebar() {
  // Function to apply active and inactive styles
  const navLinkStyles = ({ isActive }) => {
    return `flex items-center p-4 transition-colors duration-200 ${
  ...
  return (
    <div className="w-64 bg-gray-800 text-white h-screen fixed left-0 top-0 overflow-y-auto">
      <div className="p-4 text-xl font-bold border-b border-gray-700">RD Models</div>
      <nav className="mt-4">
        <ul>
          <li>
            <NavLink to="sms-stats" className={navLinkStyles}>
